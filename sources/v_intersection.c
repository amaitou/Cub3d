...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/01 19:54:47 by amait-ou          #+#    #+#             */
/*   Updated: 2023/10/02 22:28:56 by amait-ou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*   Updated: 2023/10/01 19:54:28 by amait-ou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	v_intersection(t_game *game, float ray_angle, int index)
{
	...
	{
		if (is_wall(game, game->vars.next_x - game->vars.temp_vars
				, game->vars.next_y))
		{
